...
public class FloodServiceTest {
    ...
    void setUp() throws IOException {
        ...
        Person personPaul = new Person("Paul", "steph", "456 Oak St", "Culver", "97451", "841-874-6512", "Paul@email.com");
        ...
        List<MedicalRecord> medicalRecordsList = new ArrayList<>(List.of(medicalRecordsOfJohn, medicalRecordsOfClara, medicalRecordsOfPaul));
